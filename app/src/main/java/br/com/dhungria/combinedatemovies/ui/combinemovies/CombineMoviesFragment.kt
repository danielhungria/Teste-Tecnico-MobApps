...
import br.com.dhungria.combinedatemovies.adapter.CombineMoviesAdapter
import br.com.dhungria.combinedatemovies.adapter.SimilarMoviesAdapter
import br.com.dhungria.combinedatemovies.constants.Constants
...
import br.com.dhungria.combinedatemovies.databinding.CoupleChooseMoviesFragmentBinding
...
class CombineMoviesFragment : Fragment() {
    ...
    private fun onClickAdapter(it: Result) {
        ...
        if (viewModel.movieImage1.isNotEmpty() && viewModel.movieImage2.isNotEmpty()){
            viewModel.getSimilarMovies()
            binding.recyclerListMovieGenerated.visibility = View.VISIBLE
            binding.buttonNavigateNextPage.visibility = View.VISIBLE
            binding.buttonNavigatePreviousPage.visibility = View.VISIBLE
